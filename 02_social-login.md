...
![Kakao Developers 앱 목록](./img/02-16.png)
...
![카카오 로그인 일반 설정 화면](./img/02-24.png)
...
![REST API 키 카드](./img/02-23.png)

- `REST API 키` 카드에서 `클라이언트 시크릿`을 클릭한다.

![클라이언트 시크릿 화면](./img/02-22.png)
...
![Supabase Custom Providers 화면](./img/02-18.png)
...
![Custom Auth Provider 입력 화면](./img/02-19.png)
